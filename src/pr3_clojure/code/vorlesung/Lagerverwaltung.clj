(comment "
  ...
  Aktuell hat die Firma nur drei Artikel auf Lager: PlayStation 5 (10 Stück), Grafikkarten vom Typ GTX1090 (20 Stück)
  und Sonnenblumenöl (300 Flaschen). Verwenden Sie als Schlüssel die Keywords :PS5, :GTX1090 und :OEL.
...
(def anzahl (read))
(def lager-new (update lager artikel #(- % anzahl)))
(println lager-new)
